...
const Login = ({isLoggedIn,loginUser }) => {
  ...
  const loginAccount = (e) => {
    ...
    if (isLoggedIn===false){ setTb=({...tb,password:'Mess'})}
    }
  ...
  return (
    <div className="form-container sign-in-container ">
      <form action="/#">
        ...
        />
          <span className={tb.phone} name="name">Vui lòng nhập số điện thoại </span>
        <input
          type="password"
          name="password"
          ...
          onChange={(e) => onchange(e)}
        />
          <span className={tb.password} name="name">Vui lòng nhập mật khẩu </span>
