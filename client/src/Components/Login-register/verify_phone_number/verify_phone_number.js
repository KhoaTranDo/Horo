...
class VerifyPhoneNumber extends Component {
  ...
  Click_send_otp=(e)=>{
    ...
    {
      this.setState({
          error_message:"Please check your phone number"
      })
    }else{
          ...
          <div className="modal fade" id="modalVerifyPhone_Nb_Form" tabIndex={-1} role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
              <div className="modal-dialog" role="document">
                  <div className="modal-content">
                      ...
                      <h4 className="modal-title w-100 font-weight-bold">Phone number verification</h4>
                      ...
                      <div className="modal-body mx-3">
                          ...
                          <div className="row row_form_phone_nb " >
                            ...
                            <div className=" col-md-3 col-sm-4 col-xs-4 bnt_form_phone_nb">
                                  <input type="button" value="Send OTP" onClick={(e)=>this.Click_send_otp(e)} disabled={this.state.disabled_input_phone_NB}/>
                            </div>
                          ...
                          { this.state.result_send_opt &&
                              <div className="row row_form_phone_nb">
                                ...
                                <div className=" col-md-3 col-sm-4 col-xs-4 bnt_form_phone_nb">
                                      <input type="button" value="Confirm" onClick={this.Click_key_Otp} />
                                </div>
